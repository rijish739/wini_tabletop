"""Compatibility entrypoint for the canonical tutor runtime.

The implementation lives in ``cloud_run_service/tutor_loop.py``. This shim
exists for documented local commands and imports; it contains no policy.
"""
...
_CANONICAL_FILE = _CANONICAL_ROOT / "tutor_loop.py"
...
def _load_canonical() -> None:
    ...
    if spec is None or spec.loader is None:
        ...
        raise ImportError(f"cannot load canonical tutor runtime: {_CANONICAL_FILE}")
...
def main() -> None:
    ...
    while True:
        ...
        if out.get("session_ended"):
            ...
            break
>>>>>>> 28f4360dc1eb523869eb5566d9d5c0855c201aa2


if __name__ == "__main__":
    sys.path.insert(0, str(_CANONICAL_ROOT))
    runpy.run_path(str(_CANONICAL_FILE), run_name="__main__")
else:
    _load_canonical()

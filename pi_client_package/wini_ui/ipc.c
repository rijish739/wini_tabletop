...
/* One inbound command line. Must stay ABOVE mode_channel.py's MAX_LINE (1900):
 * a longer line is truncated mid-JSON here and the whole command is lost. Raised
 * 512 -> 2048 on 2026-07-23 so a full explanation body fits — the old budget is
 * what forced the sink to clip explanations to 200 chars. */
#define IPC_LINE_MAX 2048

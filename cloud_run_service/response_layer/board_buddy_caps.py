...
TOOL_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "tree": {
        "note": "A factor tree / hierarchical decomposition diagram. root node value (e.g. 6) "
                "with branches to child factor pairs (e.g. 2 and 3).",
        "required": ["root", "pos"],
        "optional": {"branches": None, "size": "medium", "color": None, "title": None},
        "grounded": [],
        "grounded_text": ["root", "title"],
    },
    "animation": {

...
# Ticket 11: test_low_stt_confidence_preserves_state_and_pending_hook deleted.
# _low_confidence_result and trusted_observations["stt_confidence"] were removed in
# ticket 11.  The invariant "VOICE below confidence floor must not mutate state" is
# enforced via Authorization.UNAUTHORIZED — see test_repair_roundtrip.py.
